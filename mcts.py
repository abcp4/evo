...
def main():
    ...
    # Toy text
    #Runner(rec_dir, 'RoomWorld-v0',   loops=10, playouts=10, max_depth=50).run()
    Runner(rec_dir, 'RoomWorldFinalBig-v0', loops=20, playouts=50, max_depth=70).run()
